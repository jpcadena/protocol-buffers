...
const ::City& Street::_Internal::city(const Street* msg) {
...
Street::Street(const Street& from) : ::google::protobuf::Message() {
...
const ::_pbi::TcParseTable<1, 2, 1, 19, 2> Street::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(Street, _impl_._has_bits_),
    0, // no _extensions_
...
::uint8_t* Street::_InternalSerialize(
  ...
  if (!this->_internal_name().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "Street.name");
...
const ::google::protobuf::Message::ClassData*Street::GetClassData() const { return &_class_data_; }
