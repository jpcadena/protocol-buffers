...
const ::City& Address::_Internal::city(const Address* msg) {
  return *msg->_impl_.city_;
}
const ::Street& Address::_Internal::street(const Address* msg) {
  return *msg->_impl_.street_;
}
const ::Building& Address::_Internal::building(const Address* msg) {
...
const ::_pbi::TcParseTable<2, 3, 3, 0, 2> Address::_table_ = {
  {
    ...
    {::_pbi::TcParser::GetTable<::Building>()},
  }}, {{
  }},
};
