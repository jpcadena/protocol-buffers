...
class City final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:City) */ {
 public:
  ...
  void set_allocated_country_name(std::string* ptr);
...
inline PROTOBUF_ALWAYS_INLINE void City::set_country_name(Arg_&& arg,
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.country_name_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void City::set_allocated_country_name(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.country_name_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
