...
const ::uint32_t TableStruct_building_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    PROTOBUF_FIELD_OFFSET(::building::Building, _impl_._has_bits_),
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::building::Building, _impl_.name_),
    PROTOBUF_FIELD_OFFSET(::building::Building, _impl_.number_),
    PROTOBUF_FIELD_OFFSET(::building::Building, _impl_.street_),
    ~0u,
    ~0u,
    0,
};
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, 11, -1, sizeof(::building::Building)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::building::_Building_default_instance_._instance,
};
...
const ::street::Street& Building::_Internal::street(const Building* msg) {
...
Building::Building(const Building& from) : ::google::protobuf::Message() {
...
const ::_pbi::TcParseTable<2, 3, 1, 30, 2> Building::_table_ = {
  {
...
::uint8_t* Building::_InternalSerialize(
  ...
  if (!this->_internal_name().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "building.Building.name");
...
const ::google::protobuf::Message::ClassData*Building::GetClassData() const { return &_class_data_; }
