...
class Street final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:street.Street) */ {
 public:
...
inline void Street::unsafe_arena_set_allocated_city(::city::City* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
...
inline void Street::set_allocated_city(::city::City* value) {
