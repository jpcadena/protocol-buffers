...
const ::uint32_t TableStruct_city_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::city::City, _impl_.name_),
    PROTOBUF_FIELD_OFFSET(::city::City, _impl_.zip_code_),
    PROTOBUF_FIELD_OFFSET(::city::City, _impl_.country_name_),
};
...
City::City(const City& from) : ::google::protobuf::Message() {
  ...
  if (!from._internal_country_name().empty()) {
    _this->_impl_.country_name_.Set(from._internal_country_name(), _this->GetArenaForAllocation());
  }
...
const ::_pbi::TcParseTable<2, 3, 0, 42, 2> City::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
...
::uint8_t* City::_InternalSerialize(
  ...
  if (!this->_internal_name().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "city.City.name");
  ...
  if (!this->_internal_zip_code().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "city.City.zip_code");
  ...
  if (!this->_internal_country_name().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "city.City.country_name");
...
const ::google::protobuf::Message::ClassData*City::GetClassData() const { return &_class_data_; }
...
void City::InternalSwap(City* other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.country_name_, lhs_arena,
